<?php
class Fn_151 {
    function fn151_ringresos1_all($id) {
        $con = new Conecciones;
    ...
    function fn151_ringresos_all($fechadesde, $fechaasta,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT * FROM  transaccion t,  concepto c, concepto_conjunto cc "
    ...
    function fn151_ringresos_xid_usuvivienda($fechadesde, $fechaasta,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn151_ringresos2_xid_usuvivienda($id_usuvivienda,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT * FROM  transaccion t,  concepto c, concepto_conjunto cc, usuario_vivienda uv , vivienda v ,"
                . " usuario_empresa ue, usuario u where t.id_concon=cc.id_concon and c.id_concepto=cc.id_concepto "
    ...
    function fn151_detingreso1_xid($id_usuvivienda,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn151_detingreso2_xid($id_usuvivienda,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_detingreso2_xid -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
    ...
    function fn151_detingreso3_xid($id_usuvivienda,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_regresos_xnumfactura -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
    ...
    function fn151_ctrasanccion_xdata($id_empresa, $id_concon,$id_usuvivienda,$fecha_trans  ,$tipo_trans 
    ...
    function fn151_ctrasanccion2_xdata($sql) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn151_cusuario_vivienda_xdata($id_usuario, $id_vivienda) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn151_rtransaccion_xid($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn151_rtransaccion_xdata($documento_trans,$id_trans) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT * FROM  transaccion t,  concepto c, concepto_conjunto cc , usuario_vivienda uv , "
                . "vivienda v , usuario_empresa ue, usuario u   WHERE t.id_concon = cc.id_concon "
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_rtransaccion_xdata -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
            $datosNuevos = array('id_trans' => $menu['id_trans'],
                'monto_trans' => $menu['monto_trans'],
    ...
    function fn151_verifvivienda_xid($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_verifvivienda_xid -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
    ...
    function fn151_rusuario_xcedula($cedula_usuario) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_rvivienda_xnumpiso -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
    ...
    function fn151_rconcepto_conjunto_xid($idconcepto, $idconjunto ) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_rconcepto_conjunto_xid -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
    ...
    function fn151_uusuario_xest($id,$estado) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn151_estado_xid($id_estado){
        $res="PENDIENTE";
        if($id_estado==1){
            $res="PAGADO";
        }if($id_estado==2){
    ...
    function fn151_utransaccion_xdata($documento_trans, $monto_trans, $oberva_trans, $id_trans) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $fecha = date('Y-m-d');
    ...
    function fn151_rviviendas_xpiso_all($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_rviviendas_xpiso_all -- fn151 ";
            exit;
        } else {
            $arreglo = $resultado2;
        }
    ...
    function fn151_rviviendas_xdepa_all($id,$piso_vivienda) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_rviviendas_xdepa_all -- fn151 ";
            exit;
        } else {
            $arreglo = $resultado2;
        }
    ...
    function fn151_rconceptos_xtipo($tipo,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT * FROM  concepto c, concepto_conjunto cc WHERE c.id_concepto=cc.id_concepto and c.tipo_concepto = $tipo and cc.id_empresa= $id";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
    ...
    function fn151_rusuario_vivienda($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_rusuario_vivienda -- fn151 ";
            exit;
        } else {
            $arreglo = $resultado2;
        }
    ...
    function fn151_rfinanza_xdata($numcuenta_finanza,$descripcion_finanza,$tipo_finanza,$valor_finanza,$saldoanterior_finanza,$saldoactual_finanza,$numdoc_finanza) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $fecha=date('Y-m-d');
    ...
    function fn151_detingresototal1_xid($fechadesde,$fechaasta,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_detingresototal1_xid -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
            $datosNuevos = array('nregistro' => $menu['nregistro']);
            array_push($arreglo, $datosNuevos);
    ...
    function fn151_detingresototal2_xid($fechadesde,$fechaasta,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT  SUM(t.monto_trans) as vpagado FROM  transaccion t,  concepto c, concepto_conjunto cc    "
                . "WHERE t.fecha_trans >= '$fechadesde' and t.fecha_trans <= '$fechaasta'   "
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_detingresototal2_xid -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
            $datosNuevos = $menu['vpagado'];
        }
    ...
    function fn151_detingresototal3_xid($fechadesde,$fechaasta,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT  SUM(t.monto_trans) as vxpagar FROM  transaccion t,  concepto c, concepto_conjunto cc   "
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_detingresototal3_xid -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
            $datosNuevos = $menu['vxpagar'];
        }
    ...
    function fn151_detingresototal1_all($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT COUNT(t.id_trans) as nregistro FROM  transaccion t,  concepto c, concepto_conjunto cc  "
                . "where t.id_concon=cc.id_concon and c.id_concepto=cc.id_concepto and cc.id_empresa = $id   ";
    ...
    function fn151_detingresototal2_all($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT sum(t.monto_trans) as vpagado FROM  transaccion t,  concepto c, concepto_conjunto cc  "
    ...
    function fn151_detingresototal3_all($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT sum(t.monto_trans) as vxpagar FROM  transaccion t,  concepto c, concepto_conjunto cc  "
                . "where t.id_concon=cc.id_concon and c.id_concepto=cc.id_concepto and cc.id_empresa = $id "
    ...
    function fn151_rhabitante_xid($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn151_rhabitante_xid -- fn151";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
    ...
    function fn151_utransaccion_xid($id,$archivo) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
