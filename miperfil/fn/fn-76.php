<?php
class Fn_76 {
    function fn76_rusuario_all() {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT * FROM usuario WHERE estado_usuario != -1";
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn76_rusuario_all -- fn76 ";
            exit;
        } else {
            $arreglo = $resultado2;
        }
    ...
    function fn76_cusuario_xdata($nombre_usuario, $apellido_usuario, $telefono_usuario, $email_usuario, $cedula_usuario,$estado) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $fecha=date('Y-m-d');
    ...
    function fn76_rusuario_x($id) {
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn76_rusuario_x -- fn76";
            exit;
    ...
    function fn76_uusuario_x($nombre_usuario, $apellido_usuario,$telefono_usuario,$email_usuario, $cedula_usuario,$id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn76_uavisos_ximg($id, $img) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn76_uusuario_xest($id,$estado) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn76_estado_xid($id_estado){
        $res="INACTIVO";
        if($id_estado==1){
            $res="ACTIVO";
        }
    ...
    function fn76_uusuario_xpass($id, $clave) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn76_rrol_all() {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT * FROM rol WHERE estado_rol != -1";
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn76_rrol_all -- fn76 ";
            exit;
        } else {
            $arreglo = $resultado2;
        }
    ...
    function fn76_rusuario_xrol($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn76_uusuario_xrol -- fn76";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
    ...
    function fn76_uusuario_xrol($id,$idrol) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
