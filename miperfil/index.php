...
//unset($_SESSION['sesionkantar']);

include './config.php';
include './controlador/conexion.php';
include './sesiones/opensesion.php';
include './funciones/funcion-menuprin.php';
$m = new Fn_menu();
$msg = '';
$msge = '';
...
if (isset($_GET['opc'])) {
    $opc = $_GET['opc'];
    $detopc = $m->fn_rmenu2_xid($opc);
}
if ($estadousu_open == 0) {
    $opc = "";
    header('Location: ./login.php');
} else {
    if ($m->validamenu($idroll_open, $opc) == 0) {
        $opc = "-1";
        unset($_SESSION['sesionwisu']);
        header('Location: ./login.php?msg=PERMISOS DENEGADOS');
    }
}


//echo $opc;
//unset($_SESSION['sesionwow']);
?>
<!DOCTYPE html>
<html lang="en">


    <!-- Mirrored from makaanlelo.com/tf_products_007/tixia/xhtml/app-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Aug 2022 19:20:14 GMT -->
    <head>
        <meta charset="utf-8">
        ...
        <div id="main-wrapper">
            ...
            ***********************************-->
            <div class="nav-header">
                <a href="index.php?opc=4" class="brand-logo">
                    <div style="display: flex !important; margin-left: 10%;">
                        <div style="background: #000000; padding: 5px 20px; border-radius: 5px 0px 0px 5px;"><span style="color: #FFFFFF; font-weight: 800">MIN</span></div> 
                        <div style="background: #ef4444; padding: 5px 20px; border-radius: 0px 5px 5px 0px;"><span style="color: #FFFFFF; font-weight: 800">FRITID</span></div> 
                    </div>
                </a>
    ...
    ***********************************-->
            ...
            ***********************************-->
            ...
            <?php
            if (filesize('./opc/opc_' . $opc . '.php') < 1) {
                include './opc/opc_0.php';
            } else {
                include './opc/opc_' . $opc . '.php';
            }
            ?>
    ...
    <!-- Mirrored from makaanlelo.com/tf_products_007/tixia/xhtml/app-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Aug 2022 19:20:26 GMT -->
</html>