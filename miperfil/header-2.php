    ...
    <div class="collapse navbar-collapse justify-content-between">
        <div class="header-left">
            <div class="dashboard_bar">
                <?php echo $detopc[0]['nombre_menu']; ?>
            </div>
        </div>
        <div class="header-left">
            <div class="dashboard_bar">
                <?php echo $m->fn4_rtipoconjunto_xid($verificarhabitatd[0]['tipo_empresa']); ?>
                <?php echo $m->fn4_rtipoconjunto2_xid($verificarhabitatd[0]['tipo_empresa']).' '. $verificarhabitatd[0]['nombre_empresa']; ?>
            </div>
        </div>
...
<!--                            <li>
            ...
            <li class="nav-item dropdown header-profile">
                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                    <img src="images/profile/perfil.png" width="20" alt=""/>
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    <a href="index.php?opc=2" class="dropdown-item ai-icon">
                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                        <span class="ms-2">Mis Datos </span>
                    </a>
                    <a href="./sesiones/sesion.php?sesionout=1" class="dropdown-item ai-icon">
            ...
            <li class="dropdown schedule-event-inner primary">
                <a href="javascript:void(0)" class="btn btn-primary btn-rounded event-btn">
                    ...
                    <span class="d-none d-xl-inline-block">Calendario</span>
