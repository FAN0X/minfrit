...
if ($opc_mod == 1) {
    ...
    <div class="modal-footer">
        ...
        <button type="button"  onclick="cn76_f1()" data-bs-dismiss="modal" class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
...
if ($opc_mod == 2) {
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-bs-dismiss="modal">Cerrar</button>
        <button onclick="cn76_f2()" type="button" class="btn btn-warning" data-bs-dismiss="modal">Guardar cambios</button>
    </div>
    <?php
}
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_delete">
                ...
                <button type="button" onclick="cn76_f7(7, <?php echo $id ?>, -1)"  class="btn btn-primary" data-bs-dismiss="modal">SI</button>
            </form>
        </div>
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_password">
                ...
                <center>
                    <button onclick="cn76_f5()" type="button" class="btn btn-warning">Actualizar contraseña</button>
                </center>
            </form>
        </div>
