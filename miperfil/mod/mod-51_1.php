                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevo" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="date" name="fecha_ingreso" class="form-control" value="<?php echo $fechaactual ?>">
                                </div>
                                <label class="col-sm-12 col-form-label">Concepto</label>
                                <div class="col-sm-12">
                                    <select id="id" class="form-control" name="id_concon">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-12 col-form-label">Monto *</label>
                                 <div class="col-sm-12">
                                    <input type="text" name="valor_ingreso" class="form-control" >
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Detalles</label>
                                <hr>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-6 col-form-label">Repetir (Meses)</label>
                                <label class="col-sm-6 col-form-label">Máximo mora (Días)</label>
                                <div class="col-sm-6">
...
if ($opc_mod == 2) {
    $id = $_POST['dato_1'];
    $detingreso = $a->fn51_ringreso_xid($id);
    ?>
    <!-- Material color picker -->
    <script src="vendor/moment/moment.min.js"></script>
    <script src="vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
                        ...
                        <form class="form-valide" id="frm_editar" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="numfactura_ingreso" class="form-control" value="<?php echo $detingreso[0]['numfactura_ingreso'] ?>">
                                    <?php }else{ ?>
                                    <?php echo $detingreso[0]['numfactura_ingreso'] ?>
                                    <?php } ?>
                                </div>
                                
                                <div class="col-sm-6">
                                    <?php if($detingreso[0]['estado_ingreso']==0){ ?>
                                    <input type="text" readonly="" name="valor_ingreso" class="form-control" value="<?php echo $detingreso[0]['valor_ingreso'] ?>">
                                    <?php }else{ ?>
                                ...
                                <div class="col-sm-12">
                                    <?php if($detingreso[0]['estado_ingreso']==0){ ?>
                                    <textarea id="id" name="obs_ingreso" rows="3" cols="10" class="form-control"><?php echo $detingreso[0]['obs_ingreso'] ?></textarea>
                                    <?php }else{ ?>
                                    <?php echo $detingreso[0]['obs_ingreso'] ?>
                                    <?php } ?>
                                </div>
                            </div>
                        </form>
...
if ($opc_mod == 4) {
    ...
    <script src="js/plugins-init/material-date-picker-init.js"></script>
    <div class="modal-header">
        <h5 class="modal-title">Documento a Importa</h5>
        <button type="button" class="close" data-bs-dismiss="modal"><span>&times;</span>
        </button>
    </div>
    <div class="modal-body">
