...
if ($opc_mod == 1) {
//    $pisodepa = $a->fn151_rviviendas_xpiso_all($idconj_open);
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevo" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select id="tipo_concepto" class="form-control" name="tipo_concepto" onchange="cn151_r008_d1(8,this.value)">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select id="id_concon" class="form-control" name="id_concon">
                                        ...
                                        <?php 
                                        $conseptoegresos = $a->fn151_rconceptos_xtipo(0,$idconj_open);
    ...
    <!--                                <label class="col-sm-12 col-form-label">Datos Primer Mes</label>
                                    <div class="col-sm-6">
                                        <input type="checkbox" id="cb_pm" name="firstmonth" value="1" onchange="js151_001_d()">
                                    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button"  onclick="cn151_c001_f1()"  class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
...
if ($opc_mod == 2) {
    $id = $_POST['dato_1'];
    $detingreso = $a->fn151_rtransaccion_xid($id);
    ?>
    <!-- Material color picker -->
    <script src="vendor/moment/moment.min.js"></script>
    <script src="vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
                ...
                <div class="col-md-12">
                    <div class="basic-form">
                        <form class="form-valide" id="frm_editar" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Documento Actual:</label>
                                <div class="col-sm-9" >
                                    <a href="./documentos/<?php echo utf8_encode($detingreso[0]['archivo_trans']) ?>" target="_blank"><?php echo utf8_encode($detingreso[0]['archivo_trans']) ?></a>
                                </div>
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_delete">
                ...
                <button type="button" onclick="cn151_u003_d3(3, <?php echo $id ?>, -1)"  class="btn btn-primary" data-bs-dismiss="modal">SI</button>
            </form>
        </div>
...
if ($opc_mod == 4) {
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-bs-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn151_r007_d1()"  class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
if ($opc_mod == 5) {
    $id = $_POST['dato_1'];
    $detrasaccion = $a->fn151_rtransaccion_xid($id);
    ?>
    <div class="modal-content" id="content_sm">
        <div class="modal-header">
        ...
        <div class="modal-footer">
            ...
            <button type="button" onclick="cn151_r009_f();"  class="btn btn-primary" >Guardar</button>
        </div>
