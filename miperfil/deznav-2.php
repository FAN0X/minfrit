<div class="deznav-scroll">
    <ul class="metismenu" id="menu">
        <?php
        $arregloitems = $m->fn_rmenu_xrol($idroll_open,2);
        ...
        <li <?php echo $act ?>><a class="has-arrow ai-icon " title="<?php echo utf8_encode($unMenu['nombre_menu']) ?>" href="javascript:void()" aria-expanded="false">
            ...
            <ul aria-expanded="false">
                ...
                ?>
                <li><a href="index_habitacional.php?opc=<?php echo $unsubMenu['url_menu']?>&conf=<?php echo $confirmacion ?>&dato3=<?php echo $idhabrecidencial ?>"><?php echo utf8_encode($unsubMenu['nombre_menu']) ?></a></li>
                <?php 
                }       
                ?>
            </ul>
